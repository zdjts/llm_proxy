...
const zhCN: Messages = {
  ...
  usage: {
    ...
    todayRequests: '今日请求',
    todayErrors: '今日错误',
    todayAvgLatency: '平均响应时间（今日）',
    totalTokens: '累计 Token（窗口内）',
    promptTokens: '输入 Token',
    completionTokens: '输出 Token',
    cachedTokens: '缓存命中 Token',
    costTrend: '消费趋势（逐小时）',
    requestTrend: '请求趋势（逐小时）',
    latencyTrend: '延迟趋势（逐小时）',
    tokenTrend: 'Token 趋势（逐小时）',
    modelBreakdown: '模型明细',
    thModel: '模型',
    thRequests: '请求数',
    thErrors: '错误',
  ...
  requests: {
    title: '请求历史',
    subtitle: '每条已记录的 chat completion，最新在前',
    allTenants: '全部租户',
    allHistory: '全部',
    range24h: '24小时',
    range7d: '7天',
    ...
    csv: 'CSV',
    noData: '该时间范围内暂无请求',
    noDataHint: '完成后的 chat 请求会写入 request_log 并显示在此。',
    ...
    fieldError: '错误',
    fieldErrorCode: '错误码',
    fieldPrompt: '输入 Token',
    fieldCompletion: '输出 Token',
    fieldCached: '缓存 Token',
    fieldTotal: '总 Token',
    fieldCost: '成本 (USD)',
    fieldUpstream: '上游',
    fieldUpstreamModel: '上游模型',
    fieldUserAgent: 'User-Agent',
    fieldClientIp: '客户端 IP',
    fieldFingerprint: '系统指纹',
    fieldCacheSource: '缓存来源',
    fieldReasoning: '推理 Token',
    fieldAudio: '音频 Token',
  },
  clientKeys: {
    title: '客户端密钥',
