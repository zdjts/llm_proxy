  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4 border-b border-surface-200 pb-5">
        <div>
          <h1 className="text-xl font-semibold text-surface-900 sm:text-2xl">{t.traffic.title}</h1>
      ...
      <div className="glass-card rounded-lg flex flex-wrap items-center gap-3 p-4" role="search">
        ...
        <div className="h-72">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData}>
              <defs><linearGradient id="colorReq" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#b04436" stopOpacity={0.18} /><stop offset="100%" stopColor="#b04436" stopOpacity={0} /></linearGradient></defs>
              ...
              <Area type="monotone" dataKey="requests" stroke="#b04436" fill="url(#colorReq)" strokeWidth={2} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
        ...
        <div className="h-72">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartData}>
              ...
              <YAxis tick={{ fill: '#8e877d', fontSize: 10 }} axisLine={false} tickLine={false} />
              <Tooltip contentStyle={{ background: 'white', border: '1px solid #e5e0d9', borderRadius: 8, color: '#403d38', boxShadow: '0 4px 16px rgba(41,39,36,0.08)' }} />
              <Bar dataKey="latencyMs" fill="#4f7887" radius={[4, 4, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
